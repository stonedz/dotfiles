...
manageHook' = composeAll . concat $ 
                ...
                , [className =? "Deadbeef"   --> doShift "5:music"]
...
-- workspaces
workspaces' = ["1:work", "2:console", "3:web", "4:mail", "5:music", "6", "7", "8", "9"]
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,               xK_asterisk     ), spawn "urxvt -e ranger") 
